...
namespace Addons\WeiUserCenter\Controller;
use Think\ManageBaseController;

class WeiUserCenterController extends ManageBaseController{
 ...
 function export(){
        ...
        $fields ='uid,nickname,sex,score,mobile';
        $list = M ( 'user' )->where ( $map )->field($fields)->order ( 'uid asc' )->select ();
        $sex =array('保密','男','女');
        foreach ( $list as $vo ) {
            $user['nickname'] =$this->removeEmoji($vo['nickname']);
            $user['sex'] =$sex[$vo['sex']];
            $user['score'] =$vo['score'];
            $user['mobile'] =$vo['mobile'];
            $data[] =$user;
